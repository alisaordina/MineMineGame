 ...
 * In oredr to do that, this script camera follow is attached to the camera game object. 
 * 
*/
...
public class CameraFollow : MonoBehaviour 
{
	...
	void Update () 
	{
		//In the update the tranform of the camera is declaired to the Dwarf x and y axis position
		//in order to assign the new Dwarf game object's tranformation position of the x and y axis point and
